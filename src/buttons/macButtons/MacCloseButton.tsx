import Styling from './styling_Close.module.css';
    ...
    return (
        <>
            ...
            <div id = "Mac_buttonContainer" ref = {buttonContainer_Ref} style ={ Object.assign({width :'100%', height:'100%', position :'relative', overflow : 'hidden',  }, props.custom_ContainerStyle)}> 
                <div id = "Mac_Closebutton" ref = {buttonRef} style = {Object.assign({ }, props.custom_ItemStyle)} onMouseDown={() => { if (props.handleAction != undefined) props.handleAction(); }} className={Styling.closebtn}/> 
            </div>
        </>
    );
}
